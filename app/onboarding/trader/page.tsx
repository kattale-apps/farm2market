...
export default function TraderOnboardingPage() {
  ...
  const completeOnboarding = useMutation(api.traderOnboarding.completeOnboarding);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!businessName.trim()) { setMessage({ type: "error", text: "Please enter your business/trading name" }); return; }
    if (!selectedDistrictId) { setMessage({ type: "error", text: "Please select your trading district" }); return; }
    ...
    <div style={{ padding: "clamp(1rem, 4vw, 2rem)", maxWidth: "800px", margin: "0 auto" }}>
      <div style={{
        ...
        <p style={{
          ...
          Tell us your business name and trading location so farmers and buyers can find you.
        </p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: "2rem", background: "#f3e5f5", padding: "1.5rem", borderRadius: "8px", border: "1px solid #e1bee7" }}>
            ...
            <p style={{ fontSize: "0.85rem", color: "#777", marginBottom: "1rem" }}>Where do you mainly trade?</p>
