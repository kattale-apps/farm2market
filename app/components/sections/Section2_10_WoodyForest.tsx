...
type SectionData = Partial<NonNullable<Doc<"agroFreshUGFarmValidations">["section2_10_plantedForest"]>>;
...
export function Section2_10_WoodyForest({ data, onUpdate, readOnly, preloadedWaterSource }: Props) {
