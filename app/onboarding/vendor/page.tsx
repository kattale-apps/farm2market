...
const MARKET_TYPES = [
  ...
  { value: "roadside_market", label: "Roadside Market" },
  { value: "town_market", label: "Town Market" },
  { value: "village_market", label: "Village Market" },
];
    ...
    <div style={{ padding: "clamp(1rem, 4vw, 2rem)", maxWidth: "800px", margin: "0 auto" }}>
      <div style={{
        ...
        <form onSubmit={handleSubmit}>
          {/* Location Section */}
          <div style={{ marginBottom: "2rem", background: "#fff3e0", padding: "1.5rem", borderRadius: "8px", border: "1px solid #ffe0b2" }}>
            <h2 style={{ fontSize: "clamp(1.2rem, 3vw, 1.5rem)", marginBottom: "1rem", color: "#e65100", fontFamily: '"Montserrat", sans-serif', fontWeight: "600" }}>
              📍 Location
            </h2>
          ...
          <div style={{ marginBottom: "2rem", background: "#fff3e0", padding: "1.5rem", borderRadius: "8px", border: "1px solid #ffe0b2" }}>
            ...
            <div style={{ marginBottom: "1rem" }}>
              <label style={labelStyle}>Where do you sell? *</label>
              <select value={marketType} onChange={(e) => setMarketType(e.target.value)} required style={inputStyle}>
          ...
          <button
            ...
            style={{
              ...
              fontWeight: "700", background: loading ? "#bdbdbd" : "#e65100", color: "#fff",
