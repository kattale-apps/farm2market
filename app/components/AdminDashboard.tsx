    ...
    <div style={containerStyle}>
      ...
      {isSuperAdmin && (
        <>
          ...
          >
            {/* Users */}
            <a href="/superadmin/users" style={{ textDecoration: "none" }}>
              <div
                style={{
                  ...utilityCardStyle,
                  cursor: "pointer",
              ...
              >
                ...
                <div>
                  <h3 style={{ margin: "0 0 0.5rem 0", fontSize: "1.1rem" }}>Users</h3>
                  <p style={{ margin: 0, fontSize: "0.9rem", opacity: 0.95 }}>
                    Every user by category with full details, account activation and password resets
                  </p>
                </div>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <p style={{ margin: 0, fontSize: "0.9rem", opacity: 0.95 }}>
                  Every community with its logo, members and modules
                </p>
              </div>
            </a>
