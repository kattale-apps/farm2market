...
type SectionData = Partial<NonNullable<Doc<"agroFreshUGFarmValidations">["section2_5_apiary"]>>;
...
export function Section2_5_Apiary({ data, onUpdate, readOnly }: Props) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
      ...
      <div>
        <label style={{ fontWeight: 600 }}>Current Apiary intensity (hives)</label>
        <input
          type="number"
          min="0"
          value={data?.currentApiaryIntensity ?? ""}
          onChange={(e) => handleChange("currentApiaryIntensity", e.target.value)}
          style={inputStyle}
          disabled={readOnly}
        />
      </div>
