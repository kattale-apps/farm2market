...
export function Section2Crop({ title, data, onUpdate }: Props) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
      ...
      <div style={fieldWrapperStyle}>
        <label style={labelStyle}>Area under cultivation</label>
        <input
          type="text"
          value={data?.areaUnderCultivation ?? ""}
          onChange={(e) => handleChange("areaUnderCultivation", e.target.value)}
          style={inputStyle}
        />
      </div>
      ...
      <div style={fieldWrapperStyle}>
        <label style={labelStyle}>Last harvest date</label>
        <input
          type="date"
          value={data?.lastHarvestDate ?? ""}
          onChange={(e) => handleChange("lastHarvestDate", e.target.value)}
          style={inputStyle}
        />
      </div>
    </div>
